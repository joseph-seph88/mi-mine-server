...
export class GetPostByRadiusUseCase {
    ...
    async execute(postRadiusRequestInterface: PostRadiusRequestInterface): Promise<PostResponseInterface[]> {
        return await this.postRepository.getPostsByRadius(postRadiusRequestInterface);
    }
}